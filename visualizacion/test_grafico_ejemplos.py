...
def text10():
    ...
    list_relaciones.append(Relacion('gobernaron', Palabra.palabras_dict.get('Austrias') , Palabra.palabras_dict.get('España'), position_doc=13 , lugar_sintactico='obj', importancia = 2028, id=-10))
    list_relaciones.append(Relacion('gobernaron', Palabra.palabras_dict.get('Austrias') , Palabra.palabras_dict.get('siglo'), position_doc=13 , lugar_sintactico='obl', importancia = 2041, id=-11))
    list_relaciones.append(Relacion('gobernaron', Palabra.palabras_dict.get('Austrias') , Palabra.palabras_dict.get('responsable'), position_doc=13 , lugar_sintactico='obj', importancia = 2059, id=-12))
    list_relaciones.append(Relacion('gobernaron', Palabra.palabras_dict.get('Austrias') , Palabra.palabras_dict.get('expulsión'), position_doc=13 , lugar_sintactico='obj', importancia = 2099, id=-13))
    list_relaciones.append(Relacion('en', Palabra.palabras_dict.get('siglo') , Palabra.palabras_dict.get('xvi'), position_doc=31 , lugar_sintactico='compound', importancia = 2080, id=-14))
    list_relaciones.append(Relacion('en', Palabra.palabras_dict.get('siglo') , Palabra.palabras_dict.get('xvii'), position_doc=31 , lugar_sintactico='conj', importancia = 2086, id=-15))
    list_relaciones.append(Relacion('el', Palabra.palabras_dict.get('siglo') , Palabra.palabras_dict.get('xvi'), position_doc=34 , lugar_sintactico='compound', importancia = 2080, id=-16))
    list_relaciones.append(Relacion('el', Palabra.palabras_dict.get('siglo') , Palabra.palabras_dict.get('xvii'), position_doc=34 , lugar_sintactico='conj', importancia = 2086, id=-17))
    list_relaciones.append(Relacion('y', Palabra.palabras_dict.get('siglo') , Palabra.palabras_dict.get('xvii'), position_doc=47 , lugar_sintactico='conj', importancia = 2086, id=-18))
    list_relaciones.append(Relacion('también', Palabra.palabras_dict.get('responsable') , Palabra.palabras_dict.get('Inquisición'), position_doc=68 , lugar_sintactico='nmod', importancia = 2137, id=-19))
    list_relaciones.append(Relacion('de', Palabra.palabras_dict.get('expulsión') , Palabra.palabras_dict.get('judío'), position_doc=105 , lugar_sintactico='nmod', importancia = 2203, id=-20))
    list_relaciones.append(Relacion('su', Palabra.palabras_dict.get('legado') , Palabra.palabras_dict.get('arquitectura'), position_doc=116 , lugar_sintactico='appos', importancia = 2246, id=-21))
    list_relaciones.append(Relacion('y', Palabra.palabras_dict.get('arquitectura') , Palabra.palabras_dict.get('arte'), position_doc=140 , lugar_sintactico='conj', importancia = 2269, id=-22))
    list_relaciones.append(Relacion('en', Palabra.palabras_dict.get('arquitectura') , Palabra.palabras_dict.get('Madrid'), position_doc=147 , lugar_sintactico='nmod', importancia = 2277, id=-23))
    list_relaciones.append(Relacion('en', Palabra.palabras_dict.get('arquitectura') , Palabra.palabras_dict.get('Córdoba'), position_doc=147 , lugar_sintactico='conj', importancia = 2286, id=-24))
    list_relaciones.append(Relacion('y', Palabra.palabras_dict.get('Madrid') , Palabra.palabras_dict.get('Córdoba'), position_doc=157 , lugar_sintactico='conj', importancia = 2309, id=-25))
